...
A live example of both approaches side-by-side can be found in the **Alternatives** tab of the [playground](https://matejmazur.github.io/react-schema-form/).
...
See the "Arrays" section of the [playground](https://matejmazur.github.io/react-schema-form/) for cool demos.
...
Please see [customArray.js](https://github.com/MatejMazur/react-schema-form/blob/master/playground/samples/customArray.js) for a better example.
...
Please see [customObject.js](https://github.com/MatejMazur/react-schema-form/blob/master/playground/samples/customObject.js) for a better example.
...
### Q: Does react-schema-form support Material, Ant-Design, Foundation, or [some other specific widget library or frontend style]?
